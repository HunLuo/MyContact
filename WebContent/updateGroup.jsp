					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="UpdateGroupServlet" onsubmit="return logincheck()" method="post">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 组名</label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="gname" class="col-xs-10 col-sm-5" value="${requestScope.group.gname}" placeholder="${requestScope.group.gname}"/>
										</div>
									</div>
