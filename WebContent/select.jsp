					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="FindContactServlet" onsubmit="return logincheck()" method="post">
								...
								<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 查询方式</label>
								
								<div class="col-sm-9">
											<input type="radio" value="1" name="way" checked="checked">姓名查找	
											<input type="radio" value="2" name="way">性别查找			
											<input type="radio" value="3" name="way">分组查找		
										</div>
